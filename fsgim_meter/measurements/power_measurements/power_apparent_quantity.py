"""
Defines PowerApparentQuantity class
"""
...
class PowerApparentQuantity(PowerQauantityType):

    @MeasurementQuantity.measurement_metadata_type.setter
    def measurement_metadata_type(self, val):
        if val.__class__.__name__ == 'PowerApparentType':
            self._measurement_metadata_type = val
        else:
            raise TypeError("enter object of PowerApparentType class")
...
class AccumulationKind(MeasurementsEnum):
    """
...
class DataQualifierKind(MeasurementsEnum):
    """
...
class QualityOfReading(MeasurementsEnum):
    """
...
class SiScaleCodeType(MeasurementsEnum):
    """
...
class UnitSymbolKind(MeasurementsEnum):
